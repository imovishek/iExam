      ...
      <BodyWrapper>
        ...
        <Container>
          <TileHeaderWrapper>
            ...
            <RightButtonWrapper>
              <ButtonStyled type="primary">Update Exam</ButtonStyled>
            </RightButtonWrapper>
          </TileHeaderWrapper>
          <Row columns="auto auto auto">
            ...
            <HeaderRow>
              ...
              <SelectStyled disabled value={getExamStatus(exam)}>
            ...
            <HeaderRow>
              ...
              <InputWrapper value={getDuration(exam.startDate, exam.endDate)} />
            </HeaderRow>
          ...
          <Row columns="1.2fr .7fr .7fr">
            <BodyRow>
              <TileHeaderWrapper>
                ...
                <RightButtonWrapper>
                  ...
                  <ButtonStyled type="primary">Create Question</ButtonStyled>
                </RightButtonWrapper>
              </TileHeaderWrapper>
            ...
            <BodyRow>
              ...
              <Participants
                ...
                exam={exam}
                updateExamParticipantOnUI={updateExamParticipantOnUI}
              />
            </BodyRow>
            <BodyRow>
              <TileHeaderWrapper>
                <LabelWrapper>Banned Participants</LabelWrapper>
              </TileHeaderWrapper>
              <BannedParticipants
                students={exam.bannedParticipants}
                exam={exam}
                updateExamParticipantOnUI={updateExamParticipantOnUI}
              />
            </BodyRow>
